...
###############################################################################
{
    ...
    'data': [
        'data/ir_sequence_airlines.xml',
        'data/template_mail.xml',
        'wizard/report_today_flight_view.xml',
        'wizard/file_extract_data_xlsx_view.xml',
        'wizard/report_ticket_view.xml',
        'report/report_registry.xml',
        'report/report_ticket_flight.xml',
        'security/airlines_security_view.xml',
        'views/ticket_flight_view.xml',
